...
// Work hover
const featuredWorksArr = gsap.utils.toArray(".work-container");

featuredWorksArr.forEach(element => {
    let container = gsap.utils.selector(element);
    ...
    function thumbnail_anim() {
        ...
        tl.set(container(".work-thumbnail-wrapper"), {
            x: 0,
            y: 0,
            scale: 1
        }).to(container(".work-thumbnail-wrapper"), {
            scale: 0.95,
            ease: "power3.inOut"
        });
